...
- [Installing the required indexes and references](#installing-the-required-indexes-and-references)  
3. [Running the pipeline](#running-the-pipeline)  
- [Run test data](#run-test-data)  
- [QC step](#qc-step)  
- [Preprocessing reads](#preprocessing-reads)  
- [Host read filtering](#host-read-filtering)  
- [Read classification analysis mode](#read-classification-analysis-mode)  
- [De novo assembly analysis mode](#de-novo-assembly-analysis-mode)  
- [Clustering analysis mode](#clustering-analysis-mode)  
- [Mapping to reference](#mapping-to-reference)
4. [Output files](#output-files)  
- [Preprocessing and host read filtering outputs](#Preprocessing-and-host-read-filtering-outputs)  
- [Read classification mode](#read-classification-mode)  
a. [Nucleotide taxonomic classification (Kraken 2 and Braken)](#nucleotide-taxonomic-classification-(kraken-2-and-braken))
